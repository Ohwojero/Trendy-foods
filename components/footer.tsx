      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Phone: +2348038969978</li>
              <li>Email: info@trendyfoods.com</li>
              <li>Address: 123 Food Street, Lagos</li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Follow Us</h4>
            <div className="flex gap-4">
              <button className="bg-red-600 hover:bg-red-700 text-white p-3 rounded-full transition duration-200 transform hover:scale-110">
                <WhatsAppIcon />
              </button>
              <button className="bg-red-600 hover:bg-red-700 text-white p-3 rounded-full transition duration-200 transform hover:scale-110">
                <InstagramIcon />
